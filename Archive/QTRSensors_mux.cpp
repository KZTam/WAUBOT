...
void QTRSensors::setMuxPins(const uint8_t *pins, const uint8_t sensorPin, uint8_t sensorCount) {

  mux = new admux::Mux(admux::Pin(sensorPin, INPUT, admux::PinType::Analog), admux::Pinset(pins[0], pins[1], pins[2], pins[3]));
